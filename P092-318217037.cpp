...
int main()
{
	...
	camera = Camera(glm::vec3(0.0f, 10.0f, 30.0f), glm::vec3(0.0f, 1.0f, 0.0f), -90.0f, 0.0f, 0.5f, 0.5f);
	...
	tablero = Model();
	tablero.LoadModel("Models/letrero.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model arco
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-10.5f, -0.8f, -15.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arco.RenderModel();
		...
		*/
		...
		//cambiar entre textura número 1 y número 2
