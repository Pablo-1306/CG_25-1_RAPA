...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model = glm::scale(model, glm::vec3(9.0f, 4.0f, 6.0f));
		...
		////Base
		//model = glm::translate(model, glm::vec3(.0f, -2.5f, .0f));

		//modelaux = model;

		//model = glm::scale(model, glm::vec3(9.0f, 2.0f, 6.0f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		//color = glm::vec3(1.0f, 1.0f, .0f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//meshList[4]->RenderMeshGeometry(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		////articulación 1
		//model = glm::translate(model, glm::vec3(-2.0f, 4.5f, 4.0f));
		...
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //Color
		//sp.render();
		...
		//Creación de Oso panda robótico
		...
		modelaux = model;
		// rotación letra z
		model = glm::rotate(model, glm::radians(mainWindow.getpatainf1()), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux2 = model;
		...
		//rotación de letra 0
		model = glm::rotate(model, glm::radians(mainWindow.getpalma1()), glm::vec3(0.0f, 0.0f, 1.0f));

		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 0.0f, .0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		/////////////////////////////////////
		...
		modelaux = model;
		// rotación letra x
		model = glm::rotate(model, glm::radians(mainWindow.getpatainf2()), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux2 = model;

		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 5.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(.0f, .0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 2.0f));
		//rotación letra p
		model = glm::rotate(model, glm::radians(mainWindow.getpalma2()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelaux = model;
		// rotación letra z
		model = glm::rotate(model, glm::radians(mainWindow.getpatasup1()), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux2 = model;
		...
		model = glm::translate(model, glm::vec3(.0f, 0.0f, 2.0f));
		//rotación de letra 0
		model = glm::rotate(model, glm::radians(mainWindow.getpalma3()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelaux = model;
		// rotación letra x
		model = glm::rotate(model, glm::radians(mainWindow.getpatasup2()), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux2 = model;
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 2.0f));
		//rotación letra p
		model = glm::rotate(model, glm::radians(mainWindow.getpalma4()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelaux = model;
		//rotación letra m
		model = glm::rotate(model, glm::radians(mainWindow.getoreja1()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Oreja 2
		model = glm::translate(model, glm::vec3(-6.0f, .0f, 0.0f));
		//rotación letra n
		model = glm::rotate(model, glm::radians(mainWindow.getoreja2()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Ojo 1
		model = glm::translate(model, glm::vec3(-1.0f, -3.0f, 2.7f));
		modelaux = model;
		//rotación de llanta 1 // letra u
		model = glm::rotate(model, glm::radians(mainWindow.getllanta1()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Ojo 2
		model = glm::translate(model, glm::vec3(-4.0f, .0f, .0f));
		//rotación de llanta 1 // letra u
		model = glm::rotate(model, glm::radians(mainWindow.getllanta1()), glm::vec3(0.0f, 0.0f, 1.0f));
